...
public class MobileKeyword {
	...
	public static void preTest(String username, String password) {
		...
		Mobile.setText(findTestObject('Mobiles/Login Screens/EditText - Username'), username, 0)

		Mobile.setText(findTestObject('Mobiles/Login Screens/EditText - Password'), password, 0)
